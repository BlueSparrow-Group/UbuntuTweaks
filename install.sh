...
sudo apt install -y ca-certificates curl gnupg apt-transport-https unzip git snapd openjdk-17-jre openjdk-17-jre libfuse2 libreoffice gimp gimp-data-extras gimp-help-common inkscape inkscape-open-symbols inkscape-tutorials kdenlive blender handbrake filezilla obs-studio codeblocks codeblocks-common codeblocks-contrib codeblocks-dev libcodeblocks0 thonny arduino dconf-cli dconf-editor mc
